...
test(async (t) => {
...

  {
    ...
    t.is(getMetricValue(lines, 'hyperswarm_total_bytes_transmitted') > 1, true, 'hyperswarm_total_bytes_transmitted')
    t.is(getMetricValue(lines, 'hyperswarm_total_packets_transmitted') > 1, true, 'hyperswarm_total_packets_transmitted')
    t.is(getMetricValue(lines, 'hyperswarm_total_bytes_received') > 1, true, 'hyperswarm_total_bytes_received')
    t.is(getMetricValue(lines, 'hyperswarm_total_packets_received') > 1, true, 'hyperswarm_total_packets_received')
